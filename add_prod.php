    ...
    <tr>
      ...
      <td align="left" valign="middle">
       ...
       ?>
            ...
            <form action="/WEB-APP/script/product/after_add_prod.php" METHOD="post">
              <b><font color="#454545" size ="5">Введите название продукта</font></b>
              <INPUT TYPE="text" name="name" required required size="30"> <p><br>

              <b><font color="#454545" size ="5">Выберите размерность</font></b>
              ...
              <b><font color="#454545" size ="5">Введите срок хранения</font></b>
      ...
      <td width="300" height="670" background="/WEB-APP/img/111.png">
