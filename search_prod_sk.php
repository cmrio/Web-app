  ...
  <table width="100%" cellspacing="0" cellpadding="5">
    <tr>
      ...
      <?php
       ...
       ?>
        <b><font color="#454545" size ="6">Поиск продуктов на складе </font></b> <br><br><br><br><br><br><br>

       <form action="/WEB-APP/script/poisk/search_prod_sk_count.php" METHOD="post">
        ...
        <br>
        <br>
        <form action="/WEB-APP/script/poisk/search_prod_sk_str.php" METHOD="post">
              <b><font color="#454545" size ="5">Введите оставшийся срок хранения </font></b><br><br>
              <?php
              echo '<INPUT TYPE="number" name = "str" min="1" required > и более  ';
              ?>           
        <INPUT TYPE="Submit" VALUE= "Поиск продуктов по скроку хранения"  > <br>
        </form>
        
        <br>
        <br>
        <br>
        <form action="/WEB-APP/script/poisk/search_prod_sk_prov.php" METHOD="post">
              <b><font color="#454545" size ="5">Введите имя поставщика </font></b><br><br>
              <?php
              echo '<INPUT TYPE="text" name = "prov" required >    ';
              ?>           
        <INPUT TYPE="Submit" VALUE= "Поиск продуктов по поставщику"  > <br>
        </form>

        <br>
        <br>
        <br>
        <form action="/WEB-APP/script/poisk/search_prod_sk_ord.php" METHOD="post">
              <b><font color="#454545" size ="5">Введите номер заказа </font></b><br><br>
              <?php
              echo '<INPUT TYPE="text" name = "ord" required >   ';
              ?>           
        <INPUT TYPE="Submit" VALUE= "Поиск продуктов по заказу"  > <br>
        </form>
