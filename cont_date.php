...
<head>
 ...
 <img src="/WEB-APP/img/up.png" width="100%" height="17">
  ...
  <table width="100%" cellspacing="0" cellpadding="5">
    <tr>
      <td background="/WEB-APP/img/111.png" width="20%" height="670">
      </td>
      <td width="12%">
      </td>
      ...
      <?php
       ...
       ?>
       <b><font color="#454545" size ="6">Поиск договоров </font></b><br><br><br><br><br><br><br><br><br><br><br><br><br>

       <form action="/WEB-APP/script/poisk/search_cont.php" METHOD="post">
              <?php
              echo '<b>С</b>  <INPUT TYPE="date" name = "dates" required VALUE='.$row['current_date'].'>    ';
              echo '<b>По</b>  <INPUT TYPE="date" name = "datee" required VALUE='.$row['current_date'].'>    ';
              ?>     
            
        <INPUT TYPE="Submit" VALUE= "Поиск договора"  > <br>
        </form>
