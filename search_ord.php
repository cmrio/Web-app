  ...
  <table width="100%" cellspacing="0" cellpadding="5">
    <tr>
      ...
      <?php
       ...
       ?>
        <b><font color="#454545" size ="6">Поиск заказов </font></b> <br><br><br><br><br>

        <form action="/WEB-APP/script/poisk/search_ord_prod.php" METHOD="post">
              <b><font color="#454545" size ="4">Введите название продукта </font></b><br><br>
              <?php
              echo '<INPUT TYPE="text" name = "prod" required >    ';
              ?>           
        <INPUT TYPE="Submit" VALUE= "Поиск заказов по продукту"  > 
        </form>
        
        <br>
        <form action="/WEB-APP/script/poisk/search_ord_prov.php" METHOD="post">
              <b><font color="#454545" size ="4">Введите имя поставщика </font></b><br><br>
              <?php
              echo '<INPUT TYPE="text" name = "prov" required >    ';
              ?>           
        <INPUT TYPE="Submit" VALUE= "Поиск заказов по поставщику"  > <br>
        </form>

        <br>
        <form action="/WEB-APP/script/poisk/search_ord_CZ.php" METHOD="post">
              <b><font color="#454545" size ="4">Введите количество единиц продукта при заказе</font></b><br><br>
              <?php
              echo '<INPUT TYPE="number" min="1" name = "CZ" required > и более  ';
              ?>           
        <INPUT TYPE="Submit" VALUE= "Поиск заказов по количеству при заказе"  > <br>
        </form>

        <br>
        <form action="/WEB-APP/script/poisk/search_ord_CC.php" METHOD="post">
              <b><font color="#454545" size ="4">Введите количество единиц продукта на складе</font></b><br><br>
              <?php
              echo '<INPUT TYPE="number" min="1" name = "CC" required > и более  ';
              ?>           
        <INPUT TYPE="Submit" VALUE= "Поиск заказов по количеству на складе"  > <br>
        </form>
     
        <br>
        <form action="/WEB-APP/script/poisk/search_ord_date.php" METHOD="post">
              <b><font color="#454545" size ="4">Выберите даты</font></b><br><br>
              <?php
              echo '<b>С  </b><INPUT TYPE="date" name = "ds" value='.$row['current_date'].' required >   ';
              echo '<b>По  </b><INPUT TYPE="date" name = "de" value='.$row['current_date'].' required >   ';
              ?>           
        <INPUT TYPE="Submit" VALUE= "Поиск заказов по дате"  > <br>
        </form>

        <br>
        <form action="/WEB-APP/script/poisk/search_ord_summa.php" METHOD="post">
              <b><font color="#454545" size ="4">Введите сумму заказа</font></b><br><br>
              <?php
              echo '<INPUT TYPE="number" min="1" name = "summa" required > грн и более  ';
              ?>           
        <INPUT TYPE="Submit" VALUE= "Поиск заказов по цене"  > <br>
        </form>
