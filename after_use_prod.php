  ...
  <table width="100%" cellspacing="0" cellpadding="5">
    <tr>
      ...
      <td align="middle">
       ...
       if($s <= $curr_count){
        $sql = "INSERT INTO used (id_ord_usd, count_usd, date_usd) VALUES (?,?,?)";
        $stmt= $pdo->prepare($sql);
        if($stmt->execute([$prod,$s,$d])){ 
          echo '<b><font color="#454545" size ="3">'.'Продукт использован!'.'</font></b><br><br>';
          ...
          echo '<b><font color="#454545" size ="3">'.'Нету такого количества продукта на складе!'.'</font></b><br><br>';
