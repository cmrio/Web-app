  ...
  <table width="100%" cellspacing="0" cellpadding="5">
    <tr>
      ...
      <?php
       ...
       $sql = "UPDATE ord SET count = ?, date = ?, number_ord = ? where id_ord = ?";
          $stmt= $pdo->prepare($sql);
          if($stmt->execute([$c, $d, $n,$id_ord])){ 
           echo '<b><font color="#454545" size ="3">'.'Заказ изменен!'.'</font></b><br>';
           echo'<img src="/WEB-APP/img/ok.png"width="370"height="280">'.'<br>';
           echo'<a href="/WEB-APP/script/zakaz/postavki_act.php" class="button8">Просмотр заказов</a>';
                                           }
