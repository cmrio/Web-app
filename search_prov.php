  ...
  <table width="100%" cellspacing="0" cellpadding="5">
    <tr>
      ...
      <?php
       ...
       ?>
       <b><font color="#454545" size ="6">Поиск поставщиков</font></b><br><br><br><br><br><br><br><br><br><br>
   
       <form action="/WEB-APP/script/poisk/search_prov_address.php" METHOD="post">
              <b><font color="#454545" size ="5">Введите адрес </font></b><br><br>
              <?php
              echo '<INPUT TYPE="text" name = "address" required>';
              ?>
            
        <INPUT TYPE="Submit" VALUE= "Поиск поставщиков по адресу"  > <br>
        </form>
      ...
      <form action="/WEB-APP/script/poisk/search_prov_phone.php" METHOD="post">
              <b><font color="#454545" size ="5">Введите номер телефона </font></b><br><br>
              <?php
              echo '<INPUT TYPE="text" name = "phone" required>';
              ?>                     
            
        <INPUT TYPE="Submit" VALUE= "Поиск поставщиков по номеру"  > <br>
        </form>
