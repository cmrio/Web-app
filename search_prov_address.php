  ...
  <table width="100%" cellspacing="0" cellpadding="5">
    <tr>
      ...
      <td align="left" width="15%" height="670" background= "/WEB-APP/img/111.png">
        <a href="/WEB-APP/script/poisk/search_prov.php" class="button8">Вернуться</a>
      </td>
       ...
       $stmt = $pdo->query ('SELECT name_prov, address_prov, phone_prov 
        ...
        if(mb_strtoupper($row['address_prov']) == mb_strtoupper($adr)) {
        ...
        if($i != 0) {
         ...
         <td align="left" width="20%" height="670" background= "/WEB-APP/img/111.png">
