  ...
  <table width="100%" cellspacing="0" cellpadding="5">
    <tr>
      ...
      <?php
       ...
       ?>
        <b><font color="#454545" size ="6">Поиск списанных продуктов </font></b> <br><br><br><br><br><br><br><br>

       <form action="/WEB-APP/script/poisk/search_prod_dis_count.php" METHOD="post">
        ...
        <form action="/WEB-APP/script/poisk/search_prod_dis_date.php" METHOD="post">
        ...
        <br>
        <br>
        <form action="/WEB-APP/script/poisk/search_prod_dis_summa.php" METHOD="post">
              <b><font color="#454545" size ="5">Введите сумму </font></b><br><br>
              <?php
              echo '<INPUT TYPE="number" name = "summa" min="1" required > грн и более  ';
              ?>           
        <INPUT TYPE="Submit" VALUE= "Поиск продуктов по сумме"  > <br>
        </form>
